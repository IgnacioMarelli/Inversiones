document.addEventListener('DOMContentLoaded', async () => {
    const inversiones = [
        {nombre:'BTC', id:'bitcoin', precioDeCompra: 119000, cantidadComprada:0.01255, tipo: 'crypto'},
        {nombre:'SOL', id:'solana', precioDeCompra:184.46, cantidadComprada:1.355302, tipo:'crypto'},
        {nombre:'ETH', id:'ethereum', precioDeCompra:3881.023, cantidadComprada:0.032208, tipo:'crypto'},
    ...
    async function renderizarDashboard() {
        ...
        gananciaPerdidaTotal=gananciaPerdidaTotal+74;
